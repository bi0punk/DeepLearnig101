...
def preprocess_data(x_train, y_train):
    ...
    return x_train_padded, y_train_encoded, tokenizer, max_seq_length, num_classes

def build_model(tokenizer, max_seq_length, num_classes):
...
x_train_padded, y_train_encoded, tokenizer, max_seq_length, num_classes = preprocess_data(x_train, y_train)

# Construir el modelo
model = build_model(tokenizer, max_seq_length, num_classes)

# Especificar el nombre del archivo del modelo entrenado
model_filename = "trained_model.h5"

# Entrenar el modelo
train_model(model, x_train_padded, y_train_encoded, epochs=100)
